...
// IDL:FIPA/MTS:1.0
//
final public class MTSHelper
{
    public static void
    insert(org.omg.CORBA.Any any, MTS val)
    {
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_interface_tc(id(), "MTS");
        }
    ...
    read(org.omg.CORBA.portable.InputStream in)
    {
        ...
        _MTSStub _ob_stub = new _MTSStub();
        _ob_stub._set_delegate(_ob_impl._get_delegate());
        return _ob_stub;
    }

    public static void
    write(org.omg.CORBA.portable.OutputStream out, MTS val)
    {
