 ...
 * @author Pawel Veselov (vps@phoenix.math.spbu.ru)
 */
public class Crypt {
     ...
     *
     * @param show	    if it is true, print test results to err stream
     ...
     * crypt function.
     *
     * @param salt	    two byte array with salt.
     ...
     * crypt function
     *
     * @param salt	    Two bytes array with salt
