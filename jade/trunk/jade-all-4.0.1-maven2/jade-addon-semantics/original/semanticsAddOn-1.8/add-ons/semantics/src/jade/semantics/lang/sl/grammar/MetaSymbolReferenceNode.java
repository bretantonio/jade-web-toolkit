...
{
    public static Integer ID = new Integer(53);
    @Override
	public final int getClassID() {return ID.intValue();}
    java.lang.String _lx_name;
    Symbol _sm_value;

    public MetaSymbolReferenceNode(java.lang.String lx_name)  {
        super(0);
        lx_name(lx_name);
    }
	...
	public void copyValueOf(Node n, HashMap clones) {
        if (n instanceof MetaSymbolReferenceNode) {
            ...
            MetaSymbolReferenceNode tn = (MetaSymbolReferenceNode)n;
            lx_name( tn._lx_name);
	...
	public void setAttribute(int attrname, Object attrvalue) {
        ...
        if ( attrname == sm_value_ID) {sm_value((Symbol)attrvalue);return;}
