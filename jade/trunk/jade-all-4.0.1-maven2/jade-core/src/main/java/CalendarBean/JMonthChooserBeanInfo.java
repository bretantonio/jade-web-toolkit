...
public class JMonthChooserBeanInfo extends SimpleBeanInfo
{
   ...
   {
      icon    = loadImage ("images/JMonthChooserColor16.gif");
      icon32  = loadImage ("images/JMonthChooserColor32.gif");
      iconM   = loadImage ("images/JMonthChooserMono16.gif");
      icon32M = loadImage ("images/JMonthChooserMono32.gif");
   }
   ...
   public PropertyDescriptor[] getPropertyDescriptors()
   {
	 ...
	 if( PropertyEditorManager.findEditor( Locale.class ) == null )
	 {
	    ...
	    propertyDescriptors [0] = new PropertyDescriptor( "locale", JMonthChooser.class );
