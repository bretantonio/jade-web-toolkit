 ...
 */
public class SnifferRequester extends ToolRequester {

	/* (non-Javadoc)
	 * @see jade.tools.ascml.launcher.toolRequesters.ToolRequester
	 */
	public SnifferRequester(AgentLauncher launcher) {
		super(launcher);
	}
	...
	protected String getToolClass() {
		return "jade.tools.sniffer.Sniffer";
	}
	...
	public String getToolOptionName() {
		return IToolOption.TOOLOPTION_SNIFF;
	}
