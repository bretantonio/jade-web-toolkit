...
public class DependencyAgentType extends JPanel implements ActionListener
{
	private JSpinner spinnerQuantity;
    private JTextField textFieldTypeName;
	private JCheckBox checkBoxActive;

	private IAgentTypeDependency dependency;
	 ...
	 *                                  Apply-button.
	 */
	public DependencyAgentType(IAgentTypeDependency dependency)
	{
