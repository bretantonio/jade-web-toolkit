...
package examples.rdfcontent.ontology;
...
public class PeopleOntology extends Ontology {
	...
	public PeopleOntology(Ontology base) {
		...
		try {
			...
			fatherOfSchema.add(FATHER,   personSchema);
			fatherOfSchema.add(CHILDREN, (ConceptSchema)getSchema(PERSON),1 , 5, BasicOntology.SEQUENCE);
