...
public class Jade4SpringUtils {
     ...
     * @throws IOException
     */
    private static ExtendedProperties readPropertiesFromClassPathOrFile(final String propertiesFile)
            throws IOException {
     ...
     */
    public static ProfileImpl createBootProfileFromPropertiesFileOrClassPathResource(
    ...
    private static ProfileImpl addAllPropertiesToProfile(ExtendedProperties properties) {
        ...
        // Sets the AgentMobilityService and NotificationService as default MTPS
        // when the AgentContainer is started
