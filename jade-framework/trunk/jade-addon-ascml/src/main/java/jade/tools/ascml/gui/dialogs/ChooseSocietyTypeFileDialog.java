 ...
 */
public class ChooseSocietyTypeFileDialog extends AbstractDialog
{
	 ...
	 */
	public ChooseSocietyTypeFileDialog(Repository repository)
	{
		super(repository);
		...
		FileFilter filter = new FileFilter()
		{
			...
			{
				return "SocietyType-files (*.society.xml)";
			}
			...
			public boolean accept(File f)
			{
				...
				return name.endsWith(".society.xml") || f.isDirectory();
			}
		};
	...
	{
		// show the dialog
		if(fileChooser.showDialog(parentFrame, "Choose SocietyType ...") == JFileChooser.APPROVE_OPTION)
		{
