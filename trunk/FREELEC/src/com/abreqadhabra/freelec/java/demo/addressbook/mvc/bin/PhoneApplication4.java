 ...
 */
public class PhoneApplication4 extends Frame implements Serializable {
	private AddressBookPatternListUI ivjAddressBookPatternListUI1 = null;
	private AddressBookUI ivjAddressBookUI1 = null;
...
class IvjEventHandler implements java.awt.event.WindowListener {
		...
		public void windowClosing(java.awt.event.WindowEvent e) {
			if (e.getSource() == PhoneApplication4.this) 
				connEtoC1(e);
		};
	 ...
	 */
	public PhoneApplication4(String title) {
		super(title);
	}
	...
	public static void main(java.lang.String[] args) {
		try {
			PhoneApplication4 aPhoneApplication4;
			aPhoneApplication4 = new PhoneApplication4();
			aPhoneApplication4.addWindowListener(new java.awt.event.WindowAdapter() {
				public void windowClosing(java.awt.event.WindowEvent e) {
					System.exit(0);
				};
			});
			aPhoneApplication4.setVisible(true);
	 ...
	 */
	/* WARNING: THIS METHOD WILL BE REGENERATED. */
	private AddressBookUI getAddressBookUI1() {
		if (ivjAddressBookUI1 == null) {
			try {
				ivjAddressBookUI1 = new AddressBookUI();
	...
	private SimpleAddressData getsimpleAddressData() {
		if (ivjsimpleAddressData == null) {
			try {
				ivjsimpleAddressData = new SimpleAddressData();
				// user code begin {1}
				// user code end
			} catch (java.lang.Throwable ivjExc) {
				// user code begin {2}
