...
class IvjEventHandler implements java.awt.event.ActionListener, java.beans.PropertyChangeListener {
	 ...
	 * @param newValue AddressDataModel
	 */
	/* WARNING: THIS METHOD WILL BE REGENERATED. */
	...
	/**
	 * connEtoM1:  (findButton.action.actionPerformed(java.awt.event.ActionEvent) --> anAddressBookModel.find(Ljava.lang.String;)LAddressDataModel;)
	 * @return AddressDataModel
	...
	/**
	 * connEtoM2:  ( (findButton,action.actionPerformed(java.awt.event.ActionEvent) --> anAddressBookModel,find(Ljava.lang.String;)LAddressDataModel;).normalResult --> anAddressDataModel.this)
	 * @param result AddressDataModel
	 */
	/* WARNING: THIS METHOD WILL BE REGENERATED. */
	...
	/**
	 * connEtoM3:  (addButton.action.actionPerformed(java.awt.event.ActionEvent) --> anAddressBookModel.add(LAddressDataModel;)V)
	 * @param arg1 java.awt.event.ActionEvent
	 */
	/* WARNING: THIS METHOD WILL BE REGENERATED. */
	...
	/**
	 * connEtoM4:  ( (findButton,action.actionPerformed(java.awt.event.ActionEvent) --> anAddressBookModel,find(Ljava.lang.String;)LAddressDataModel;).exceptionOccurred --> Dialog1.show()V)
