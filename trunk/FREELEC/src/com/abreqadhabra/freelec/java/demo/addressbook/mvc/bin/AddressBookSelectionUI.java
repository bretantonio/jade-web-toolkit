 ...
 */
public class AddressBookSelectionUI extends Panel implements Serializable {
	...
	class IvjEventHandler implements java.awt.event.ActionListener,
		...
		public void actionPerformed(java.awt.event.ActionEvent e) {
			if (e.getSource() == AddressBookSelectionUI.this.getfindButton())
				connEtoM1(e);
			if (e.getSource() == AddressBookSelectionUI.this.getaddButton())
				connEtoM3(e);
			if (e.getSource() == AddressBookSelectionUI.this.getokButton())
				connEtoM5(e);
		};

		public void propertyChange(java.beans.PropertyChangeEvent evt) {
			if (evt.getSource() == AddressBookSelectionUI.this
					.getanAddressDataSelectionModel()
					&& (evt.getPropertyName().equals("selection")))
				connPtoP2SetTarget();
			if (evt.getSource() == AddressBookSelectionUI.this.getentryUI()
	 ...
	 */
	public AddressBookSelectionUI(LayoutManager layout) {
		super(layout);
	}
	 ...
	 * 
	 * @param newValue
	 *            AddressDataSelectionModel
	 */
	/* WARNING: THIS METHOD WILL BE REGENERATED. */
	private void setanAddressDataSelectionModel(
			AddressDataSelectionModel newValue) {
		if (ivjanAddressDataSelectionModel != newValue) {
			try {
				...
				if (ivjanAddressDataSelectionModel != null) {
					ivjanAddressDataSelectionModel
				...
				connPtoP2SetTarget();
				firePropertyChange("addressDataSelectionModel", oldValue,
						newValue);
				// user code begin {1}
				// user code end
			} catch (java.lang.Throwable ivjExc) {
	 ...
	 * 
	 * @return AddressDataEntryFormUI
	 */
	/* WARNING: THIS METHOD WILL BE REGENERATED. */
	private AddressDataEntryFormUI getentryUI() {
		if (ivjentryUI == null) {
			try {
				ivjentryUI = new AddressDataEntryFormUI();
	...
	/**
	 * connEtoM1: (findButton.action.actionPerformed(java.awt.event.ActionEvent)
	 * --> anAddressBookModel.find(Ljava.lang.String;)LAddressDataModel;)
	 * 
	 * @return AddressDataModel
	 * @param arg1
	...
	private AddressDataModel connEtoM1(java.awt.event.ActionEvent arg1) {
		AddressDataModel connEtoM1Result = null;
		try {
			// user code begin {1}
			// user code end
			if ((getanAddressDataModel() != null)) {
				connEtoM1Result = getanAddressBookModel().find(
	...
	/**
	 * connEtoM2: (
	 * (findButton,action.actionPerformed(java.awt.event.ActionEvent) -->
	 * anAddressBookModel
	 * ,find(Ljava.lang.String;)LAddressDataModel;).normalResult -->
	 * anAddressDataModel.this)
	 * 
	 * @param result
	 *            AddressDataModel
	 */
	...
	/**
	 * connEtoM3: (addButton.action.actionPerformed(java.awt.event.ActionEvent)
	 * --> anAddressBookModel.add(LAddressDataModel;)V)
	 * 
	 * @param arg1
	 *            java.awt.event.ActionEvent
	 */
	 ...
	 * (findButton,action.actionPerformed(java.awt.event.ActionEvent) -->
	 * anAddressBookModel
	 * ,find(Ljava.lang.String;)LAddressDataModel;).exceptionOccurred -->
	 * Dialog1.show()V)
	 * 
	 * @param exception
	 *            java.lang.Throwable
	...
	/**
	 * connEtoM5: (okButton.action.actionPerformed(java.awt.event.ActionEvent)
	 * --> Dialog1.dispose()V)
	 * 
	 * @param arg1
	 *            java.awt.event.ActionEvent
	...
	/**
	 * connPtoP2SetSource: (anAddressDataSelectionModel.selection <-->
	 * anAddressDataModel.this)
	 */
	/* WARNING: THIS METHOD WILL BE REGENERATED. */
	private void connPtoP2SetSource() {
		...
		try {
			if (ivjConnPtoP2Aligning == false) {
				...
				if ((getanAddressDataSelectionModel() != null)
						&& (getanAddressDataModel() != null)) {
					getanAddressDataSelectionModel().setSelection(
	...
	/**
	 * connPtoP2SetTarget: (anAddressDataSelectionModel.selection <-->
	 * anAddressDataModel.this)
	 */
	/* WARNING: THIS METHOD WILL BE REGENERATED. */
	private void connPtoP2SetTarget() {
		...
		try {
			if (ivjConnPtoP2Aligning == false) {
				...
				// user code end
				ivjConnPtoP2Aligning = true;
				setanAddressDataModel(getanAddressDataSelectionModel()
						.getSelection());
				// user code begin {2}
				// user code end
				ivjConnPtoP2Aligning = false;
	...
	/**
	 * Method generated to support the promotion of the addressBookModel
	 * attribute.
	 * 
	 * @return AddressBookModel
	 */
	...
	/**
	 * Method generated to support the promotion of the addressDataModel
	 * attribute.
	 * 
	 * @return AddressDataModel
	 */
	 ...
	 * addressDataSelectionModel attribute.
	 * 
	 * @return AddressDataSelectionModel
	 */
