...
import com.abreqadhabra.freelec.java.demo.addressbook.mvc.model.AddressDataFactoryModel;
...
public class HashAddressBook implements Serializable, AddressBookModel {
	...
	private AddressDataModel[] fieldAddresses = null;
	 ...
	 * @param address AddressDataModel
	 */
	...
	/**
	 * Gets the addressDataFactory property (AddressDataFactoryModel) value.
	...
	/**
	 * Gets the addresses property (AddressDataModel[]) value.
	...
	/**
	 * Gets the addresses index property (AddressDataModel) value.
	 * @return The addresses property value.
	...
	/**
	 * Sets the addressDataFactory property (AddressDataFactoryModel) value.
