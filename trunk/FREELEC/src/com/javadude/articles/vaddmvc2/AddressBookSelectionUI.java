...
class IvjEventHandler implements java.awt.event.ActionListener, java.beans.PropertyChangeListener {
		...
		public void propertyChange(java.beans.PropertyChangeEvent evt) {
			if (evt.getSource() == AddressBookSelectionUI.this.getanAddressDataSelectionModel() && (evt.getPropertyName().equals("selection"))) 
				connPtoP2SetTarget();
			if (evt.getSource() == AddressBookSelectionUI.this.getentryUI() && (evt.getPropertyName().equals("model"))) 
				connPtoP1SetSource();
		};
	};
	 ...
	 */
	/* WARNING: THIS METHOD WILL BE REGENERATED. */
	private com.javadude.articles.vaddmvc1.AddressBookModel getanAddressBookModel() {
		// user code begin {1}
		// user code end
	 ...
	 */
	/* WARNING: THIS METHOD WILL BE REGENERATED. */
	private void setanAddressBookModel(com.javadude.articles.vaddmvc1.AddressBookModel newValue) {
	 ...
	 */
	/* WARNING: THIS METHOD WILL BE REGENERATED. */
	private com.javadude.articles.vaddmvc1.AddressDataModel getanAddressDataModel() {
		// user code begin {1}
		// user code end
	 ...
	 */
	/* WARNING: THIS METHOD WILL BE REGENERATED. */
	private void setanAddressDataModel(com.javadude.articles.vaddmvc1.AddressDataModel newValue) {
	 ...
	 * @return com.javadude.articles.vaddmvc2.AddressDataSelectionModel
	 */
	/* WARNING: THIS METHOD WILL BE REGENERATED. */
	 ...
	 * @param newValue com.javadude.articles.vaddmvc2.AddressDataSelectionModel
	 */
	/* WARNING: THIS METHOD WILL BE REGENERATED. */
	private void setanAddressDataSelectionModel(AddressDataSelectionModel newValue) {
		if (ivjanAddressDataSelectionModel != newValue) {
			try {
				com.javadude.articles.vaddmvc2.AddressDataSelectionModel oldValue = getanAddressDataSelectionModel();
	 ...
	 */
	/* WARNING: THIS METHOD WILL BE REGENERATED. */
	private com.javadude.articles.vaddmvc1.AddressDataEntryFormUI getentryUI() {
		if (ivjentryUI == null) {
			try {
	 ...
	 */
	/* WARNING: THIS METHOD WILL BE REGENERATED. */
	private com.javadude.articles.vaddmvc1.AddressDataModel connEtoM1(java.awt.event.ActionEvent arg1) {
	 ...
	 */
	/* WARNING: THIS METHOD WILL BE REGENERATED. */
	private void connEtoM2(com.javadude.articles.vaddmvc1.AddressDataModel result) {
		try {
			// user code begin {1}
			// user code end
	...
	/**
	 * connPtoP2SetSource:  (anAddressDataSelectionModel.selection <--> anAddressDataModel.this)
	 */
	/* WARNING: THIS METHOD WILL BE REGENERATED. */
	private void connPtoP2SetSource() {
		...
		try {
			if (ivjConnPtoP2Aligning == false) {
				...
				if ((getanAddressDataSelectionModel() != null) && (getanAddressDataModel() != null)) {
					getanAddressDataSelectionModel().setSelection(getanAddressDataModel());
				}
				// user code begin {2}
				// user code end
	...
	/**
	 * connPtoP2SetTarget:  (anAddressDataSelectionModel.selection <--> anAddressDataModel.this)
	 */
	/* WARNING: THIS METHOD WILL BE REGENERATED. */
	private void connPtoP2SetTarget() {
		...
		try {
			if (ivjConnPtoP2Aligning == false) {
				...
				// user code end
				ivjConnPtoP2Aligning = true;
				setanAddressDataModel(getanAddressDataSelectionModel().getSelection());
				// user code begin {2}
				// user code end
				ivjConnPtoP2Aligning = false;
			}
	...
	/**
	 * Method generated to support the promotion of the addressDataSelectionModel attribute.
	 * @param arg1 com.javadude.articles.vaddmvc2.AddressDataSelectionModel
	 */
