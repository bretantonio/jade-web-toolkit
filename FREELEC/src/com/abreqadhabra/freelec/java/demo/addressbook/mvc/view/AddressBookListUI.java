...
public class AddressBookListUI extends List implements Serializable {
	...
	class IvjEventHandler implements java.beans.PropertyChangeListener {
		public void propertyChange(java.beans.PropertyChangeEvent evt) {
			if (evt.getSource() == AddressBookListUI.this
					.getanAddressBookModel()
					&& (evt.getPropertyName().equals("addresses")))
				connEtoC1(evt);
		};
	};
	...
	public static void main(java.lang.String[] args) {
		try {
			...
			System.err
					.println("Exception occurred in main() of AddressBookListUI");
	...
	/**
	 * connEtoC1: (anAddressBookModel.addresses -->
	 * AddressBookListUI.loadList([LAddressDataModel;Ljava.awt.List;)V)
	 * 
	 * @param arg1
