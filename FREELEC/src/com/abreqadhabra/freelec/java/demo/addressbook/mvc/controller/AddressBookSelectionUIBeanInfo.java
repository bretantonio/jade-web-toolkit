...
import com.abreqadhabra.freelec.java.demo.addressbook.mvc.bin.AddressBookSelectionUI;
...
/**
 * The bean information class for AddressBookSelectionUI.
 */
public class AddressBookSelectionUIBeanInfo extends java.beans.SimpleBeanInfo {
	...
	public static java.lang.Class getBeanClass() {
		return AddressBookSelectionUI.class;
	}
	...
	public java.beans.BeanDescriptor getBeanDescriptor() {
		...
		try {
			...
			aDescriptor = new java.beans.BeanDescriptor(AddressBookSelectionUI.class);
			/* aDescriptor.setExpert(false); */
			/* aDescriptor.setHidden(false); */
