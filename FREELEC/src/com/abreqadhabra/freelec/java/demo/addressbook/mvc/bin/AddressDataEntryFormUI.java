...
/**
 * This sample code is provided "as is" and is intended for demonstration
 * purposes only.
 * 
 * Neither Scott Stanchfield nor IBM shall be held liable for any damages
 * resulting from your use of this code.
 * 
...
public class AddressDataEntryFormUI extends Panel implements Serializable {
	...
	class IvjEventHandler implements java.awt.event.TextListener,
			java.beans.PropertyChangeListener {
		public void propertyChange(java.beans.PropertyChangeEvent evt) {
			if (evt.getSource() == AddressDataEntryFormUI.this
					.getanAddressDataModel()
					&& (evt.getPropertyName().equals("name")))
				connPtoP1SetTarget();
			if (evt.getSource() == AddressDataEntryFormUI.this
					.getanAddressDataModel()
					&& (evt.getPropertyName().equals("address")))
				connPtoP2SetTarget();
			if (evt.getSource() == AddressDataEntryFormUI.this
					.getanAddressDataModel()
					&& (evt.getPropertyName().equals("city")))
				connPtoP3SetTarget();
			if (evt.getSource() == AddressDataEntryFormUI.this
					.getanAddressDataModel()
			...
			if (evt.getSource() == AddressDataEntryFormUI.this
					.getanAddressDataModel()
					&& (evt.getPropertyName().equals("country")))
				connPtoP5SetTarget();
			if (evt.getSource() == AddressDataEntryFormUI.this
					.getanAddressDataModel()
					&& (evt.getPropertyName().equals("postalCode")))
				connPtoP6SetTarget();
			if (evt.getSource() == AddressDataEntryFormUI.this
					.getanAddressDataModel()
					&& (evt.getPropertyName().equals("homePhone")))
				connPtoP7SetTarget();
			if (evt.getSource() == AddressDataEntryFormUI.this
					.getanAddressDataModel()
					&& (evt.getPropertyName().equals("businessPhone")))
				connPtoP8SetTarget();
		};

		public void textValueChanged(java.awt.event.TextEvent e) {
			if (e.getSource() == AddressDataEntryFormUI.this
					.getNameTextField1())
				connPtoP1SetSource();
			if (e.getSource() == AddressDataEntryFormUI.this
					.getAddressTextField1())
				connPtoP2SetSource();
			if (e.getSource() == AddressDataEntryFormUI.this
					.getCityTextField1())
				connPtoP3SetSource();
			if (e.getSource() == AddressDataEntryFormUI.this
				...
				connPtoP4SetSource();
			if (e.getSource() == AddressDataEntryFormUI.this
					.getCountryTextField1())
				connPtoP5SetSource();
			if (e.getSource() == AddressDataEntryFormUI.this
					.getPostalCodeTextField1())
				connPtoP6SetSource();
			if (e.getSource() == AddressDataEntryFormUI.this
					.getHomePhoneTextField1())
				connPtoP7SetSource();
			if (e.getSource() == AddressDataEntryFormUI.this
					.getBusinessPhoneTextField1())
				connPtoP8SetSource();
		};
	};
	...
	public static void main(java.lang.String[] args) {
		try {
			...
			System.err
					.println("Exception occurred in main() of java.awt.Panel");
	...
	private void setanAddressDataModel(AddressDataModel newValue) {
		if (ivjanAddressDataModel != newValue) {
			try {
				AddressDataModel oldValue = getanAddressDataModel();
				/* Stop listening for events from the current object */
				if (ivjanAddressDataModel != null) {
					ivjanAddressDataModel
							.removePropertyChangeListener(ivjEventHandler);
				}
	...
	private java.awt.Label getBusinessPhoneLabel1() {
		if (ivjBusinessPhoneLabel1 == null) {
			try {
				...
				ivjBusinessPhoneLabel1
						.setFont(new java.awt.Font("serif", 3, 14));
	...
	private java.awt.Panel getPanel1() {
		if (ivjPanel1 == null) {
			try {
				...
				constraintsNameLabel1.gridx = 1;
				constraintsNameLabel1.gridy = 3;
				...
				constraintsNameTextField1.gridx = 2;
				constraintsNameTextField1.gridy = 3;
				...
				constraintsNameTextField1.insets = new java.awt.Insets(4, 4, 4,
						4);
				...
				constraintsAddressLabel1.gridx = 1;
				constraintsAddressLabel1.gridy = 6;
				constraintsAddressLabel1.anchor = java.awt.GridBagConstraints.WEST;
				constraintsAddressLabel1.insets = new java.awt.Insets(4, 4, 4,
						4);
				...
				constraintsAddressTextField1.gridx = 2;
				constraintsAddressTextField1.gridy = 6;
				...
				constraintsAddressTextField1.insets = new java.awt.Insets(4, 4,
						4, 4);
				getPanel1().add(getAddressTextField1(),
						constraintsAddressTextField1);

				java.awt.GridBagConstraints constraintsCityLabel1 = new java.awt.GridBagConstraints();
				constraintsCityLabel1.gridx = 1;
				constraintsCityLabel1.gridy = 7;
				...
				constraintsCityTextField1.gridx = 2;
				constraintsCityTextField1.gridy = 7;
				...
				constraintsCityTextField1.insets = new java.awt.Insets(4, 4, 4,
						4);
				...
				constraintsStateLabel1.gridx = 3;
				constraintsStateLabel1.gridy = 7;
				...
				constraintsStateTextField1.gridx = 4;
				constraintsStateTextField1.gridy = 7;
				...
				constraintsStateTextField1.insets = new java.awt.Insets(4, 4,
						4, 4);
				getPanel1().add(getStateTextField1(),
						constraintsStateTextField1);

				java.awt.GridBagConstraints constraintsCountryLabel1 = new java.awt.GridBagConstraints();
				constraintsCountryLabel1.gridx = 1;
				constraintsCountryLabel1.gridy = 8;
				constraintsCountryLabel1.anchor = java.awt.GridBagConstraints.WEST;
				constraintsCountryLabel1.insets = new java.awt.Insets(4, 4, 4,
						4);
				...
				constraintsCountryTextField1.gridx = 2;
				constraintsCountryTextField1.gridy = 8;
				...
				constraintsCountryTextField1.insets = new java.awt.Insets(4, 4,
						4, 4);
				getPanel1().add(getCountryTextField1(),
						constraintsCountryTextField1);

				java.awt.GridBagConstraints constraintsPostalCodeLabel1 = new java.awt.GridBagConstraints();
				constraintsPostalCodeLabel1.gridx = 3;
				constraintsPostalCodeLabel1.gridy = 8;
				constraintsPostalCodeLabel1.anchor = java.awt.GridBagConstraints.WEST;
				constraintsPostalCodeLabel1.insets = new java.awt.Insets(4, 4,
						4, 4);
				getPanel1().add(getPostalCodeLabel1(),
						constraintsPostalCodeLabel1);

				java.awt.GridBagConstraints constraintsPostalCodeTextField1 = new java.awt.GridBagConstraints();
				constraintsPostalCodeTextField1.gridx = 4;
				constraintsPostalCodeTextField1.gridy = 8;
				...
				constraintsPostalCodeTextField1.insets = new java.awt.Insets(4,
						4, 4, 4);
				getPanel1().add(getPostalCodeTextField1(),
						constraintsPostalCodeTextField1);

				java.awt.GridBagConstraints constraintsHomePhoneLabel1 = new java.awt.GridBagConstraints();
				constraintsHomePhoneLabel1.gridx = 1;
				constraintsHomePhoneLabel1.gridy = 11;
				constraintsHomePhoneLabel1.anchor = java.awt.GridBagConstraints.WEST;
				constraintsHomePhoneLabel1.insets = new java.awt.Insets(4, 4,
						4, 4);
				getPanel1().add(getHomePhoneLabel1(),
						constraintsHomePhoneLabel1);

				java.awt.GridBagConstraints constraintsHomePhoneTextField1 = new java.awt.GridBagConstraints();
				constraintsHomePhoneTextField1.gridx = 2;
				constraintsHomePhoneTextField1.gridy = 11;
				...
				constraintsHomePhoneTextField1.insets = new java.awt.Insets(4,
						4, 4, 4);
				getPanel1().add(getHomePhoneTextField1(),
						constraintsHomePhoneTextField1);

				java.awt.GridBagConstraints constraintsBusinessPhoneLabel1 = new java.awt.GridBagConstraints();
				constraintsBusinessPhoneLabel1.gridx = 1;
				constraintsBusinessPhoneLabel1.gridy = 14;
				constraintsBusinessPhoneLabel1.anchor = java.awt.GridBagConstraints.WEST;
				constraintsBusinessPhoneLabel1.insets = new java.awt.Insets(4,
						4, 4, 4);
				getPanel1().add(getBusinessPhoneLabel1(),
						constraintsBusinessPhoneLabel1);

				java.awt.GridBagConstraints constraintsBusinessPhoneTextField1 = new java.awt.GridBagConstraints();
				constraintsBusinessPhoneTextField1.gridx = 2;
				constraintsBusinessPhoneTextField1.gridy = 14;
				...
				constraintsBusinessPhoneTextField1.insets = new java.awt.Insets(
						4, 4, 4, 4);
				getPanel1().add(getBusinessPhoneTextField1(),
						constraintsBusinessPhoneTextField1);
				// user code begin {1}
				// user code end
			} catch (java.lang.Throwable ivjExc) {
				// user code begin {2}
		...
		try {
			if (ivjConnPtoP1Aligning == false) {
				...
				if ((getanAddressDataModel() != null)) {
					getanAddressDataModel().setName(
							getNameTextField1().getText());
				}
				// user code begin {2}
				// user code end
	...
	private void connPtoP1SetTarget() {
		...
		try {
			if (ivjConnPtoP1Aligning == false) {
				...
				ivjConnPtoP1Aligning = true;
				if ((getanAddressDataModel() != null)) {
					getNameTextField1().setText(
							getanAddressDataModel().getName());
				}
				// user code begin {2}
				// user code end
				ivjConnPtoP1Aligning = false;
	...
	/**
	 * connPtoP2SetSource: (anAddressDataModel.address <-->
	...
	private void connPtoP2SetSource() {
		...
		try {
			if (ivjConnPtoP2Aligning == false) {
				...
				if ((getanAddressDataModel() != null)) {
					getanAddressDataModel().setAddress(
							getAddressTextField1().getText());
				}
				// user code begin {2}
				// user code end
	...
	/**
	 * connPtoP2SetTarget: (anAddressDataModel.address <-->
	 * AddressTextField1.text)
	 */
	/* WARNING: THIS METHOD WILL BE REGENERATED. */
	private void connPtoP2SetTarget() {
		...
		try {
			if (ivjConnPtoP2Aligning == false) {
				...
				ivjConnPtoP2Aligning = true;
				if ((getanAddressDataModel() != null)) {
					getAddressTextField1().setText(
							getanAddressDataModel().getAddress());
				}
				// user code begin {2}
				// user code end
				ivjConnPtoP2Aligning = false;
	...
	private void connPtoP3SetSource() {
		...
		try {
			if (ivjConnPtoP3Aligning == false) {
				...
				if ((getanAddressDataModel() != null)) {
					getanAddressDataModel().setCity(
							getCityTextField1().getText());
				}
				// user code begin {2}
				// user code end
	...
	private void connPtoP3SetTarget() {
		...
		try {
			if (ivjConnPtoP3Aligning == false) {
				...
				ivjConnPtoP3Aligning = true;
				if ((getanAddressDataModel() != null)) {
					getCityTextField1().setText(
							getanAddressDataModel().getCity());
				}
				// user code begin {2}
				// user code end
				ivjConnPtoP3Aligning = false;
	...
	private void connPtoP4SetSource() {
		...
		try {
			if (ivjConnPtoP4Aligning == false) {
				...
				if ((getanAddressDataModel() != null)) {
					getanAddressDataModel().setState(
							getStateTextField1().getText());
				}
				// user code begin {2}
				// user code end
	...
	private void connPtoP4SetTarget() {
		...
		try {
			if (ivjConnPtoP4Aligning == false) {
				...
				ivjConnPtoP4Aligning = true;
				if ((getanAddressDataModel() != null)) {
					getStateTextField1().setText(
							getanAddressDataModel().getState());
				}
				// user code begin {2}
				// user code end
				ivjConnPtoP4Aligning = false;
	...
	/**
	 * connPtoP5SetSource: (anAddressDataModel.country <-->
	 * CountryTextField1.text)
	 */
	/* WARNING: THIS METHOD WILL BE REGENERATED. */
	private void connPtoP5SetSource() {
		...
		try {
			if (ivjConnPtoP5Aligning == false) {
				...
				if ((getanAddressDataModel() != null)) {
					getanAddressDataModel().setCountry(
							getCountryTextField1().getText());
				}
				// user code begin {2}
				// user code end
	...
	/**
	 * connPtoP5SetTarget: (anAddressDataModel.country <-->
	 * CountryTextField1.text)
	 */
	/* WARNING: THIS METHOD WILL BE REGENERATED. */
	private void connPtoP5SetTarget() {
		...
		try {
			if (ivjConnPtoP5Aligning == false) {
				...
				ivjConnPtoP5Aligning = true;
				if ((getanAddressDataModel() != null)) {
					getCountryTextField1().setText(
							getanAddressDataModel().getCountry());
				}
				// user code begin {2}
				// user code end
				ivjConnPtoP5Aligning = false;
	...
	/**
	 * connPtoP6SetSource: (anAddressDataModel.postalCode <-->
	 * PostalCodeTextField1.text)
	 */
	/* WARNING: THIS METHOD WILL BE REGENERATED. */
	private void connPtoP6SetSource() {
		...
		try {
			if (ivjConnPtoP6Aligning == false) {
				...
				if ((getanAddressDataModel() != null)) {
					getanAddressDataModel().setPostalCode(
							getPostalCodeTextField1().getText());
				}
				// user code begin {2}
				// user code end
	...
	/**
	 * connPtoP6SetTarget: (anAddressDataModel.postalCode <-->
	 * PostalCodeTextField1.text)
	 */
	/* WARNING: THIS METHOD WILL BE REGENERATED. */
	private void connPtoP6SetTarget() {
		...
		try {
			if (ivjConnPtoP6Aligning == false) {
				...
				ivjConnPtoP6Aligning = true;
				if ((getanAddressDataModel() != null)) {
					getPostalCodeTextField1().setText(
							getanAddressDataModel().getPostalCode());
				}
				// user code begin {2}
				// user code end
				ivjConnPtoP6Aligning = false;
	...
	/**
	 * connPtoP7SetSource: (anAddressDataModel.homePhone <-->
	 * HomePhoneTextField1.text)
	 */
	/* WARNING: THIS METHOD WILL BE REGENERATED. */
	private void connPtoP7SetSource() {
		...
		try {
			if (ivjConnPtoP7Aligning == false) {
				...
				if ((getanAddressDataModel() != null)) {
					getanAddressDataModel().setHomePhone(
							getHomePhoneTextField1().getText());
				}
				// user code begin {2}
				// user code end
	...
	/**
	 * connPtoP7SetTarget: (anAddressDataModel.homePhone <-->
	 * HomePhoneTextField1.text)
	 */
	/* WARNING: THIS METHOD WILL BE REGENERATED. */
	private void connPtoP7SetTarget() {
		...
		try {
			if (ivjConnPtoP7Aligning == false) {
				...
				ivjConnPtoP7Aligning = true;
				if ((getanAddressDataModel() != null)) {
					getHomePhoneTextField1().setText(
							getanAddressDataModel().getHomePhone());
				}
				// user code begin {2}
				// user code end
				ivjConnPtoP7Aligning = false;
	...
	/**
	 * connPtoP8SetSource: (anAddressDataModel.businessPhone <-->
	 * BusinessPhoneTextField1.text)
	 */
	/* WARNING: THIS METHOD WILL BE REGENERATED. */
	private void connPtoP8SetSource() {
		...
		try {
			if (ivjConnPtoP8Aligning == false) {
				...
				if ((getanAddressDataModel() != null)) {
					getanAddressDataModel().setBusinessPhone(
							getBusinessPhoneTextField1().getText());
				}
				// user code begin {2}
				// user code end
	...
	/**
	 * connPtoP8SetTarget: (anAddressDataModel.businessPhone <-->
	 * BusinessPhoneTextField1.text)
	 */
	/* WARNING: THIS METHOD WILL BE REGENERATED. */
	private void connPtoP8SetTarget() {
		...
		try {
			if (ivjConnPtoP8Aligning == false) {
				...
				ivjConnPtoP8Aligning = true;
				if ((getanAddressDataModel() != null)) {
					getBusinessPhoneTextField1().setText(
							getanAddressDataModel().getBusinessPhone());
				}
				// user code begin {2}
				// user code end
				ivjConnPtoP8Aligning = false;
