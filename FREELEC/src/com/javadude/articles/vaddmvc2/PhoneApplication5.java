...
class IvjEventHandler implements java.awt.event.WindowListener {
	...
	private com.javadude.articles.vaddmvc1.SimpleAddressData ivjinitialSelection = null;
	 ...
	 * @return com.javadude.articles.vaddmvc2.AddressBookPatternSelectionListUI
	 */
	/* WARNING: THIS METHOD WILL BE REGENERATED. */
	private AddressBookPatternSelectionListUI getAddressBookPatternListUI1() {
		if (ivjAddressBookPatternListUI1 == null) {
			try {
				ivjAddressBookPatternListUI1 = new com.javadude.articles.vaddmvc2.AddressBookPatternSelectionListUI();
	...
	private AddressBookSelectionUI getAddressBookUI1() {
		if (ivjAddressBookUI1 == null) {
			try {
				ivjAddressBookUI1 = new com.javadude.articles.vaddmvc2.AddressBookSelectionUI();
	 ...
	 */
	/* WARNING: THIS METHOD WILL BE REGENERATED. */
	private com.javadude.articles.vaddmvc1.SimpleAddressData getinitialSelection() {
		if (ivjinitialSelection == null) {
			try {
				ivjinitialSelection = new com.javadude.articles.vaddmvc1.SimpleAddressData();
				// user code begin {1}
				// user code end
			} catch (java.lang.Throwable ivjExc) {
				// user code begin {2}
	 ...
	 * @return com.javadude.articles.vaddmvc2.SimpleAddressDataSelectionModel
	 */
	/* WARNING: THIS METHOD WILL BE REGENERATED. */
	private SimpleAddressDataSelectionModel getsimpleAddressDataSelectionModel() {
		if (ivjsimpleAddressDataSelectionModel == null) {
			try {
				ivjsimpleAddressDataSelectionModel = new com.javadude.articles.vaddmvc2.SimpleAddressDataSelectionModel();
				// user code begin {1}
				// user code end
			} catch (java.lang.Throwable ivjExc) {
				// user code begin {2}
	 ...
	 * @return com.javadude.articles.vaddmvc2.SortedAddressBook
	 */
	/* WARNING: THIS METHOD WILL BE REGENERATED. */
	private SortedAddressBook getsortedAddressBook() {
		if (ivjsortedAddressBook == null) {
			try {
				ivjsortedAddressBook = new com.javadude.articles.vaddmvc2.SortedAddressBook();
				// user code begin {1}
				// user code end
			} catch (java.lang.Throwable ivjExc) {
				// user code begin {2}
