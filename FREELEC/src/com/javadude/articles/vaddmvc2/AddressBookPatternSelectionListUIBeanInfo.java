...
/**
 * The bean information class for com.javadude.articles.vaddmvc2.AddressBookPatternSelectionListUI.
 */
public class AddressBookPatternSelectionListUIBeanInfo extends java.beans.SimpleBeanInfo {
	...
	public static java.lang.Class getBeanClass() {
		return com.javadude.articles.vaddmvc2.AddressBookPatternSelectionListUI.class;
	}
	...
	/**
	 * Gets the changeSelection(com.javadude.articles.vaddmvc1.AddressDataModel, java.awt.List) method descriptor.
	 * @return java.beans.MethodDescriptor
	 */
	...
	public java.beans.BeanDescriptor getBeanDescriptor() {
		...
		try {
			...
			aDescriptor = new java.beans.BeanDescriptor(com.javadude.articles.vaddmvc2.AddressBookPatternSelectionListUI.class);
			/* aDescriptor.setExpert(false); */
			/* aDescriptor.setHidden(false); */
		...
		try {
			try {
				...
				try {
					/* Attempt to find the method using getMethod with parameter types. */
					java.lang.Class aSetMethodParameterTypes[] = {
						com.javadude.articles.vaddmvc2.Patterned.class
					};
