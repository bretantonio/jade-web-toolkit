 ...
 */
public class ChooseJavaFileDialog extends AbstractDialog
{
	 ...
	 */
	public ChooseJavaFileDialog(Repository repository)
	{
		super(repository);
		...
		FileFilter filter = new FileFilter()
		{
			...
			public boolean accept(File f)
			{
				...
				return (name.endsWith(".java") || name.endsWith(".class") || f.isDirectory());
			}
		};
	...
	{
		// show the dialog
		if(fileChooser.showDialog(parentFrame, "Choose Java-File ...") == JFileChooser.APPROVE_OPTION)
		{
