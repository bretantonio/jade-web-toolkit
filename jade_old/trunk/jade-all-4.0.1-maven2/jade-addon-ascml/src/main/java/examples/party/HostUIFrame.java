 ...
 * Package
 * Created            1 Oct 2001
 * Filename           $RCSfile: HostUIFrame.java,v $
 * Revision           $Revision: 1.2 $
 * Release status     Experimental.  $State: Exp $
 *
 * Last modified on   $Date: 2004/08/04 18:03:02 $
 *               by   $Author: dirk $
 *
 ...
 *
 * @author Ian Dickinson, HP Labs (<a href="mailto:Ian_Dickinson@hp.com">email</a>)<br>
 *         Dirk Bade (made slight changes to run with ASCML)
 * @version CVS info: $Id: HostUIFrame.java,v 1.2 2004/08/04 18:03:02 dirk Exp $
 */
    ...
    extends JFrame
{
	...
	{
		return slide_numGuests.getValue();
	}

	public void setSlideEnabled(boolean enable)
	{
		slide_numGuests.setEnabled( enable );
	}
    ...
    private void jbInit() throws Exception {
        ...
        this.setTitle("JADE's ASCML-Party Host Agent");
        ...
        lbl_numGuests.setText("Minimum No. of guests to wait for:");
        ...
        lbl_guestCount.setText(""+m_owner.getGuestCount());
		slide_numGuests.setMinimum(1);
		slide_numGuests.setMaximum(100);
        slide_numGuests.setValue(m_owner.getGuestCount());
        ...
        lbl_partyState.setText("Waiting for first guest");
        ...
        this.getContentPane().add(btn_Exit, BorderLayout.SOUTH);
    ...
    void btn_Exit_actionPerformed(ActionEvent e) {
        m_owner.addBehaviour( new OneShotBehaviour() {
                                  public void action() {
									  // call doDelete, because doDelete forces the
									  // takeDown-method to clean up and to deregister at the DF
                                      ((HostAgent) myAgent).doDelete();
                                  }
                              } );
    }
