 ...
 * 
 */
public class AgentTypeDependency extends AbstractDependency implements IAgentTypeDependency
{
	protected String quantity;
	protected String name;

	public AgentTypeDependency()
	{
		super(AGENTTYPE_DEPENDENCY);
	}

	public AgentTypeDependency(String name, String quantity)
	{
		super(AGENTTYPE_DEPENDENCY);
		setName(name);
