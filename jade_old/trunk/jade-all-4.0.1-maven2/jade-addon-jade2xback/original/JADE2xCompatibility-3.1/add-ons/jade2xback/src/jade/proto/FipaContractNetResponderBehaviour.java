...
* @version $Date: 2003/02/25 13:59:50 $ $Revision: 1.2 $
*/
 ...
 public void reset() {
  ...
  final public void action() {
    ...
    case 2: {
      ...
      proposeMsg.setProtocol(FIPANames.InteractionProtocol.FIPA_CONTRACT_NET);
    ...
    case 4: { // send the last message
      ...
      informMsg.setProtocol(FIPANames.InteractionProtocol.FIPA_CONTRACT_NET);
