...
/**
 * HTTPAddress.java. This class is for parsing http-addresses (eg.
 * http://foo.bar).
 *
...
public class HTTPAddress implements TransportAddress {
    ...
    public HTTPAddress(URL addr) throws MalformedURLException {
        url = addr;
    }
    
    public HTTPAddress(String addr) throws MalformedURLException {
        url = new URL(addr);
    }
    
    public HTTPAddress(String addr, int port, boolean https)
