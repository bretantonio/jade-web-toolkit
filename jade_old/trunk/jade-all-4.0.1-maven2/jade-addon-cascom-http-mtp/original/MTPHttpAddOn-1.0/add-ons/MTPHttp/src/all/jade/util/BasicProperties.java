...
public class BasicProperties extends Properties {
     ...
     * @param inStream The file.
     * @throws IOException if anything goes wrong.
     */
    public synchronized void load(InputStream inStream) throws IOException {
        System.err.println("Not implemented: jade.util.BasicProperties.load");
        /*
...
*/
   ...
   * Used by isCandidate, isolateKey and isolateValue to determine
     ...
     * @param arg The argument being processed.
     */
    protected void specialHandling(String arg) throws PropertiesException {
     ...
     * @param arg The argument being processed.
     */
    protected String isolateKey(String arg) throws PropertiesException {
     ...
     */
    protected String isolateValue(String arg) throws PropertiesException {
        String value = null;
     ...
     */
    public Object put(String aKey, Object aValue) throws PropertiesException {
    ...
    public String getPropertyIgnoreCase(String aKey) {
        for (Enumeration e = super.keys(); e.hasMoreElements(); ) {
            ...
            if (aKey.toLowerCase().equals(key.toLowerCase())) {
     ...
     * @return The resultant line with all substitutions done or null if input string was.
     */
    public String doSubstitutions(String anInputString, boolean allowUndefined) throws PropertiesException  {
