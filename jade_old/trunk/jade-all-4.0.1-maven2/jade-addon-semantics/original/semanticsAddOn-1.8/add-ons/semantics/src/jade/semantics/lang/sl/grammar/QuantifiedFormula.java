...
public abstract class QuantifiedFormula extends Formula
{
    ...
    static public int as_variable_ID = new String("as_variable").hashCode();
	...
	public boolean hasAttribute(int attrname) {
        if ( attrname == as_variable_ID) return true;
	...
	public Object getAttribute(int attrname) {
        if ( attrname == as_variable_ID) return as_variable();
	...
	public void setAttribute(int attrname, Object attrvalue) {
        if ( attrname == as_variable_ID) {as_variable((Variable)attrvalue);return;}
