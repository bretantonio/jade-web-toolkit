 ...
 */
public class Propose extends SemanticInterpretationPrinciple {
    ...
    public Propose(SemanticCapabilities capabilities) {
        super(capabilities,
        	  "(B ??myself (or (not (I ??myself (done ??act ??condition))) (I ??agent (done ??act ??condition))))",
        	  SemanticInterpretationPrincipleTable.PROPOSE);
    } // End of Propose/1
