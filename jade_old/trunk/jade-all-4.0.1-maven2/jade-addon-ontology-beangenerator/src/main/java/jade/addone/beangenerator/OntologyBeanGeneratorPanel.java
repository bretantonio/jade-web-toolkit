 ...
 *  (C) 2002 TILAB S.p.A. This file is donated by yall B.V. to the JADE
...
import jade.addone.beangenerator.jatab.JessAgentTab;
...
/*
 * @author Chris van Aart - Yall, University of Amsterdam @created November 14,
 * 2002
 */
public class OntologyBeanGeneratorPanel extends JPanel {
	...
	private static String getLaunchString(String document) {
		...
		if (!isLinux()) {
			// assume KDE
			launchString = "kfmclient openURL " + document;
		} else if (isWinNT() || isWin2000()) {
	...
	private static boolean isLinux() {
		return getSystemProperty("os.name").indexOf("Linux") != -1;
	}
	...
	private void yall_mouseClicked(MouseEvent e) {
		showHTML("http://www.yall.nl");
	}

	private void yall_mouseEntered(MouseEvent e) {
		selectCursor.show();
	}

	private void yall_mouseExited(MouseEvent e) {
		selectCursor.hide();
	}
	...
	void jbInit() throws Exception {
		yall.setIcon(this.yallIcon);
		yall
				.setToolTipText("<html><h1>yall B.V.</h1> is specialized in commerical agent technology.</html>");
		yall.addMouseListener(new java.awt.event.MouseAdapter() {
		...
		jLabel2
				.setText("location excl. package (e.g. /home/chris/projects/myproject/src/)");
		itsLocateButton.setBackground(Color.white);
		itsLocateButton.setToolTipText("select a directory");
		itsLocateButton.setText("...");
		itsLocateButton.addActionListener(new java.awt.event.ActionListener() {
		...
		jLabel5.setToolTipText("<html><b>v. 4.0</b><html>");
		jLabel5.setHorizontalAlignment(SwingConstants.CENTER);
		jLabel5.setText("Ontology Bean Generator for Jade 3.1 (OWL Compliant)");
		jScrollPane1
		...
		jLabel6.setFont(new java.awt.Font("SansSerif", 2, 11));
		jLabel6
				.setText("This directory will be created if it doesn't already exist");
		packageComboBox.setBackground(Color.white);
		...
		ontologyComboBox.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ontologyComboBox_actionPerformed(e);
			}
		});
		...
		aachenLabel.setIcon(aachenIcon);
		uvaLabel.setToolTipText("http://hcs.science.uva.nl/");
		uvaLabel.setIcon(this.uvaIcon);
		uvaLabel.addMouseListener(new java.awt.event.MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
		...
		itsGenerateButton.setFont(new java.awt.Font("SansSerif", 0, 11));
		itsGenerateButton.setForeground(Color.blue);
		itsGenerateButton
				.setToolTipText("Generate beans and optional jade ontology file");
		...
		microSupport.addChangeListener(new javax.swing.event.ChangeListener() {
			public void stateChanged(ChangeEvent e) {
				microSupport_stateChanged(e);
			}
		});

		itsGenerateJessOntologyButton.setBackground(Color.white);
		itsGenerateJessOntologyButton.setFont(new java.awt.Font("SansSerif", 0,
				11));
		itsGenerateJessOntologyButton.setForeground(SystemColor.activeCaption);
		itsGenerateJessOntologyButton
				.setToolTipText("Generate Jess Ontology and Jess statement if instances are defined");
		itsGenerateJessOntologyButton.setIcon(packageIcon);
		itsGenerateJessOntologyButton.setText("Generate Jess Ontology");

		itsGenerateJessOntologyButton
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(ActionEvent e) {
						itsGenerateJessOntology_actionPerformed(e);
					}
				});
		jadeCheckBox.setFont(new java.awt.Font("SansSerif", 0, 11));
		beansCheckBox.setFont(new java.awt.Font("SansSerif", 0, 11));
		useJadeNamesCheckBox.setFont(new java.awt.Font("SansSerif", 0, 11));
		fullBeanSupport.setFont(new java.awt.Font("SansSerif", 0, 11));
		standardSupport.setFont(new java.awt.Font("SansSerif", 0, 11));
		microSupport.setFont(new java.awt.Font("SansSerif", 0, 11));
		contributors.add(yall);
		contributors.add(jadeLabel);
		contributors.add(uvaLabel);
		contributors.add(mleLabel);
		contributors.add(aachenLabel);
		rightPanel.add(itsOntologyNameButton, new GridBagConstraints(4, 7, 1,
				1, 0.0, 0.0, GridBagConstraints.NORTHEAST,
				GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
		rightPanel.add(itsPackageNameButton, new GridBagConstraints(4, 2, 1, 2,
				0.0, 0.0, GridBagConstraints.NORTH, GridBagConstraints.NONE,
				new Insets(0, 0, 0, 0), 0, 0));
		rightPanel.add(jPanel1, new GridBagConstraints(1, 10, 1, 9, 1.0, 1.0,
		...
		jPanel2.add(itsGenerateJessOntologyButton, null);
		rightPanel.add(jalopyFileLocator, new GridBagConstraints(3, 14, 1, 1,
		...
		mleLabel.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
		...
		useJadeNamesCheckBox.setSelected(true);
		useJadeNamesCheckBox.setText("use JADE names when specified");
		useJadeNamesCheckBox
				.setToolTipText("Use the \"JADE Name\" field specified in Protege");
		...
		microSupport
				.setToolTipText("Compatible with the Java 2 Micro Edition and the jade.content.onto.MicroIntrospector");
		...
		fullBeanSupport
				.setToolTipText("Compatible with the JavaBeans specification");
		fullBeanSupport.setBackground(Color.white);

		// standard support
		standardSupport.setSelected(false);
		standardSupport
				.setText("J2SE and Java 1.1 compatible [JADE, JADE-LEAP]");
		...
		doFormatting.getModel().addChangeListener(new ChangeListener() {
			public void stateChanged(ChangeEvent e) {
				...
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(ActionEvent e) {
						try {
							...
							thejFileChooser.setSelectedFile(new File(jalopyFile
									.getText()));
							thejFileChooser
									.showOpenDialog(OntologyBeanGeneratorPanel.this);
		...
		rightPanel.add(jLabel6, new GridBagConstraints(1, 4, 3, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(
						0, 0, 0, 0), 0, 0));
		rightPanel.add(packageComboBox, new GridBagConstraints(1, 2, 3, 1, 1.0,
				0.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
				new Insets(0, 0, 0, 5), 0, 0));
		rightPanel.add(locationComboBox, new GridBagConstraints(1, 5, 3, 1,
				1.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 5), 0, 0));
		rightPanel.add(ontologyComboBox, new GridBagConstraints(1, 7, 3, 1,
				1.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 5), 0, 0));
		...
		rightPanel.add(jLabel9, new GridBagConstraints(0, 7, 1, 1, 0.0, 0.0,
				GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(0,
						5, 0, 0), 0, 0));
		rightPanel.add(itsLocateButton, new GridBagConstraints(4, 5, 1, 1, 0.0,
				0.0, GridBagConstraints.WEST, GridBagConstraints.NONE,
				new Insets(0, 0, 0, 0), 0, 0));

		rightPanel.add(jadeCheckBox, new GridBagConstraints(2, 10, 1, 1, 0.0,
				0.0, GridBagConstraints.SOUTHWEST, GridBagConstraints.NONE,
				new Insets(0, 0, 0, 0), 0, 0));
		rightPanel.add(beansCheckBox, new GridBagConstraints(2, 11, 1, 1, 0.0,
				0.0, GridBagConstraints.SOUTHWEST, GridBagConstraints.NONE,
				new Insets(0, 0, 0, 0), 0, 0));

		rightPanel.add(useJadeNamesCheckBox, new GridBagConstraints(2, 12, 1,
				1, 0.0, 0.0, GridBagConstraints.SOUTHWEST,
				GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));

		rightPanel.add(doFormatting, new GridBagConstraints(2, 13, 1, 1, 0.0,
				0.0, GridBagConstraints.SOUTHWEST, GridBagConstraints.NONE,
				new Insets(0, 0, 0, 0), 0, 0));

		rightPanel.add(jalopyFile, new GridBagConstraints(2, 14, 1, 1, 0.0,
				0.0, GridBagConstraints.SOUTHWEST, GridBagConstraints.NONE,
				new Insets(0, 0, 0, 0), 0, 0));

		// JEL
		rightPanel.add(fullBeanSupport, new GridBagConstraints(2, 16, 1, 1,
				0.0, 0.0, GridBagConstraints.SOUTHWEST,
				GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
		rightPanel.add(standardSupport, new GridBagConstraints(2, 17, 1, 1,
				0.0, 0.0, GridBagConstraints.SOUTHWEST,
				GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
		rightPanel.add(microSupport, new GridBagConstraints(2, 18, 1, 1, 0.0,
				0.0, GridBagConstraints.NORTHWEST, GridBagConstraints.NONE,
				new Insets(0, 0, 0, 0), 0, 0));

		rightPanel.add(contributors, new GridBagConstraints(0, 20, 4, 1, 0.0,
		...
		/*
		 * rightPanel.add(jadeLabel, new GridBagConstraints(1, 18, 1, 1, 0.0,
		 * 0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new
		 * Insets(0, 0, 0, 0), 0, 0)); rightPanel.add(mleLabel, new
		 * GridBagConstraints(2, 18, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
		 * GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
		 * rightPanel.add(yall, new GridBagConstraints(3, 18, 1, 1, 0.0, 0.0,
		 * GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0,
		 * 0, 0), 0, 0)); rightPanel.add(uvaLabel, new GridBagConstraints(4, 18,
		 * 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE,
		 * new Insets(0, 0, 0, 0), 0, 0));
		 */
		mainSplitPane.setDividerLocation(200);
		leftPanel.add(jScrollPane1, new GridBagConstraints(0, 0, 2, 1, 1.0,
	...
	private void showHTML(String url) {
		...
		try {
			...
			wait.hide();
			JOptionPane.showMessageDialog(this, "Visit " + url
	...
	private JLabel yall = new JLabel();

	private ImageIcon yallIcon = new ImageIcon(this.getClass().getResource(
			"graphics/yall.jpg"));
	...
	private ImageIcon executeIcon = new ImageIcon(this.getClass().getResource(
			"graphics/execute.gif"));
	...
	private ImageIcon inboxIcon = new ImageIcon(this.getClass().getResource(
			"graphics/inbox.gif"));
	...
	private ImageIcon jadeIcon = new ImageIcon(this.getClass().getResource(
			"graphics/jadelogo.jpg"));
	...
	private ImageIcon mleIcon = new ImageIcon(this.getClass().getResource(
			"graphics/mle.gif"));
	...
	private ImageIcon outputIcon = new ImageIcon(this.getClass().getResource(
			"graphics/output.gif"));
	...
	private ImageIcon packageIcon = new ImageIcon(this.getClass().getResource(
			"graphics/package.gif"));
	...
	private ImageIcon uvaIcon = new ImageIcon(this.getClass().getResource(
			"graphics/uva.gif"));

	private ImageIcon aachenIcon = new ImageIcon(this.getClass().getResource(
			"graphics/rwth_logo.gif"));

	private JLabel uvaLabel = new JLabel();

	private JLabel aachenLabel = new JLabel();

	JButton itsGenerateJessOntologyButton = new JButton();

	SelectCursor selectCursor = new SelectCursor(this);
	...
	private class SomeLabelRenderer extends JLabel implements ListCellRenderer {
		...
		public Component getListCellRendererComponent(JList list, Object value,
			...
			if (value != null) {
				...
				// setIcon(new
				// ImageIcon(getClass().getResource("graphics/start.gif")));
				setText((String) value);
			}
	...
	void itsGenerateJessOntology_actionPerformed(ActionEvent e) {
		...
		Thread processor = new Thread() {
			public void run() {
				...
				JessAgentTab jessAgentTab = new JessAgentTab();
				String dirname = (String) locationBoxModel.getSelectedItem();
				jessAgentTab.initialize(model.getProject(), dirname,
						statusTextArea);
				jessAgentTab.doIt();
			}
		};
	...
	void ontologyComboBox_actionPerformed(ActionEvent e) {
